...
It contains annotations for **198 MESSIDOR images** and is designed to improve **model explainability and reliability in DR screening** :contentReference[oaicite:0]{index=0}.

⚠️ Note:
- MAPLES-DR **does not include the original fundus images**
- You must download MESSIDOR separately and align them with the labels :contentReference[oaicite:1]{index=1}
